...
import EditorHostContext from "./components/EditorHostContext";
...
export type Props = {
  ...
  /** Adapter for business data dependencies */
  hostAdapter?: EditorDataAdapter;
  /** Adapter for custom file upload implementation */
...
> {
  ...
  public componentDidUpdate(prevProps: Props) {
    ...
    if (this.props.value && prevProps.value !== this.props.value) {
      // If parent echoes back the same markdown string from onChange, avoid
      // resetting editor state as it will cause cursor jumps while typing.
      const isEchoedStringValue =
        typeof this.props.value === "string" &&
        this.view &&
        this.props.value === this.value(true, false);

      if (!isEchoedStringValue) {
    ...
    return (
      <PortalContext.Provider value={this.wrapperRef.current}>
        <EditorHostContext.Provider
          value={{
            hostAdapter: this.props.hostAdapter,
            uploadAdapter: this.props.uploadAdapter,
          }}
        >
